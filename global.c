...
const char *CONTYPEXBM = "Content-Type: image/x-xbitmap\r\n";
const char *CONTYPEXPM = "Content-Type: image/x-xpixmap\r\n";
const char *CONTYPEPNG = "Content-Type: image/x-png\r\n";
const char *CONTYPEIEF = "Content-Type: image/ief\r\n";
const char *CONTYPEJPEG = "Content-Type: image/jpeg\r\n";
const char *CONTYPETIFF = "Content-Type: image/tiff\r\n";
const char *CONTYPERGB = "Content-Type: image/rgb\r\n";
const char *CONTYPEJS = "Content-Type: text/javascript\r\n";
